...
<head>
  ...
  <style>
    ...
    .card{background:#111827;padding:32px 28px;border-radius:16px;min-width:320px;box-shadow:0 10px 30px rgba(0,0,0,.4)}
    .title{font-size:20px;margin:0 0 12px}
    .muted{font-size:12px;color:#94a3b8;margin:0 0 16px}
