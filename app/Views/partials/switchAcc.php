<div id="acc-switcher" class="fixed top-[70px] right-1 z-9999 max-[850px]:top-[50%] max-[850px]:right-[15%]">
  <div class="bg-[#0f172a] border border-[#1f2937] rounded-xl min-w-[320px] max-w-[420px] p-3.5">
    <div class="flex items-center justify-between gap-2 mb-2.5">
      ...
      <button onclick="onClose()" class="bg-[#111827] border border-[#374151] rounded-xl color-[#e5e7eb] py-1.5 px-2.5 cursor-pointer">X</button>
    </div>
